...
public final class PingResultUtil
{
  ...
  private static final String CSV_FORMAT_UP = "%s,%s,%d%%,%.2f,%.2f,%.2f";
  private static final String CSV_FORMAT_DOWN = "%s,%s,%d%%,-,-,-";
   ...
   * <p>Output format:
   * <ul>
   *   <li>Success: "IP,UP,LOSS%,MIN_RTT,AVG_RTT,MAX_RTT"</li>
   *   <li>Failure: "IP,DOWN,100%,-,-,-"</li>
   * </ul>
   *
